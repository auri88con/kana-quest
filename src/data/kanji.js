...
export const kanjiTier1 = [
  ...
  { char: '四', romaji: 'yon', meaning: 'four', emoji: '4️⃣', word: { kana: '四人', romaji: 'yonin', meaning: 'four people' }, components: ['囗', '儿'] },
  ...
  { char: '百', romaji: 'hyaku', meaning: 'hundred', emoji: '💯', word: { kana: '百円', romaji: 'hyakuen', meaning: '100 yen' }, components: ['一', '白'] },
  ...
  { char: '時', romaji: 'ji', meaning: 'hour / time', emoji: '⏰', word: { kana: '時間', romaji: 'jikan', meaning: 'time / hours' }, components: ['日', '土', '寸'] },
  { char: '分', romaji: 'fun', meaning: 'minute', emoji: '⏱️', word: { kana: '五分', romaji: 'gofun', meaning: 'five minutes' }, components: ['八', '刀'] },
  { char: '週', romaji: 'shuu', meaning: 'week', emoji: '🗓️', word: { kana: '今週', romaji: 'konshuu', meaning: 'this week' }, components: ['辶', '口'], partial: true },
  ...
  { char: '私', romaji: 'watashi', meaning: 'I / me', emoji: '🙋', word: { kana: '私たち', romaji: 'watashitachi', meaning: 'we / us' }, components: ['禾', '厶'] },
  { char: '名', romaji: 'na', meaning: 'name', emoji: '🏷️', word: { kana: '名前', romaji: 'namae', meaning: 'name' }, components: ['夕', '口'] },
  { char: '前', romaji: 'mae', meaning: 'before / front', emoji: '➡️', word: { kana: '駅前', romaji: 'ekimae', meaning: 'in front of the station' }, components: ['月', '刀'], partial: true },
  { char: '後', romaji: 'go', meaning: 'after / behind', emoji: '⬅️', word: { kana: '午後', romaji: 'gogo', meaning: 'afternoon / p.m.' }, components: ['彳'], partial: true },
  { char: '友', romaji: 'tomo', meaning: 'friend', emoji: '🤝', word: { kana: '友達', romaji: 'tomodachi', meaning: 'friend' }, components: ['又'], partial: true },
  { char: '男', romaji: 'otoko', meaning: 'man', emoji: '🚹', word: { kana: '男の子', romaji: 'otokonoko', meaning: 'boy' }, components: ['田', '力'] },
  ...
  { char: '先', romaji: 'sen', meaning: 'previous / ahead', emoji: '🏃', word: { kana: '先生', romaji: 'sensei', meaning: 'teacher' }, components: ['儿'], partial: true },
  ...
  { char: '空', romaji: 'sora', meaning: 'sky', emoji: '🌌', word: { kana: '空港', romaji: 'kuukou', meaning: 'airport' }, components: ['穴', '工'] },
  { char: '雨', romaji: 'ame', meaning: 'rain', emoji: '🌧️', word: { kana: '大雨', romaji: 'ooame', meaning: 'heavy rain' } },
  { char: '花', romaji: 'hana', meaning: 'flower', emoji: '🌸', word: { kana: '花火', romaji: 'hanabi', meaning: 'fireworks' }, components: ['艹', '人', '匕'] },
  { char: '石', romaji: 'ishi', meaning: 'stone', emoji: '🪨', word: { kana: '石けん', romaji: 'sekken', meaning: 'soap' } },
  { char: '天', romaji: 'ten', meaning: 'heaven / sky', emoji: '☁️', word: { kana: '天気', romaji: 'tenki', meaning: 'weather' }, components: ['一', '大'] },
  { char: '気', romaji: 'ki', meaning: 'spirit / feeling', emoji: '💨', word: { kana: '元気', romaji: 'genki', meaning: 'healthy / energetic' } },
  { char: '電', romaji: 'den', meaning: 'electricity', emoji: '⚡', word: { kana: '電車', romaji: 'densha', meaning: 'train' }, components: ['雨', '田'], partial: true },
  ...
  { char: '茶', romaji: 'cha', meaning: 'tea', emoji: '🍵', word: { kana: 'お茶', romaji: 'ocha', meaning: 'tea' }, components: ['艹', '木'], partial: true },
  ...
  { char: '黒', romaji: 'kuro', meaning: 'black', emoji: '⚫', word: { kana: '黒い', romaji: 'kuroi', meaning: 'black' }, components: ['田', '土', '火'], partial: true },
  ...
  { char: '左', romaji: 'hidari', meaning: 'left', emoji: '⬅️', word: { kana: '左手', romaji: 'hidarite', meaning: 'left hand' }, components: ['工'], partial: true },
  { char: '右', romaji: 'migi', meaning: 'right', emoji: '➡️', word: { kana: '右手', romaji: 'migite', meaning: 'right hand' }, components: ['口'], partial: true },
  { char: '中', romaji: 'naka', meaning: 'middle / inside', emoji: '🎯', word: { kana: '中国', romaji: 'chuugoku', meaning: 'China' } },
  { char: '外', romaji: 'soto', meaning: 'outside', emoji: '🚪', word: { kana: '外国', romaji: 'gaikoku', meaning: 'foreign country' }, components: ['夕', '卜'] },
  { char: '東', romaji: 'higashi', meaning: 'east', emoji: '🌅', word: { kana: '東京', romaji: 'toukyou', meaning: 'Tokyo' }, components: ['木', '日'] },
  ...
  { char: '北', romaji: 'kita', meaning: 'north', emoji: '🧭', word: { kana: '北口', romaji: 'kitaguchi', meaning: 'north exit' }, components: ['匕'], partial: true },
  ...
  { char: '安', romaji: 'an', meaning: 'cheap', emoji: '🏷️', word: { kana: '安い', romaji: 'yasui', meaning: 'cheap' }, components: ['宀', '女'] },
  { char: '新', romaji: 'shin', meaning: 'new', emoji: '✨', word: { kana: '新しい', romaji: 'atarashii', meaning: 'new' }, components: ['立', '木', '斤'] },
  { char: '古', romaji: 'ko', meaning: 'old', emoji: '🏺', word: { kana: '古い', romaji: 'furui', meaning: 'old' }, components: ['十', '口'] },
  { char: '多', romaji: 'ta', meaning: 'many', emoji: '➕', word: { kana: '多い', romaji: 'ooi', meaning: 'many / a lot' }, components: ['夕', '夕'] },
  { char: '少', romaji: 'shou', meaning: 'few', emoji: '➖', word: { kana: '少ない', romaji: 'sukunai', meaning: 'few / a little' }, components: ['小'], partial: true },
  ...
  { char: '行', romaji: 'kou', meaning: 'go', emoji: '🚶', word: { kana: '行く', romaji: 'iku', meaning: 'to go' }, components: ['彳'], partial: true },
  { char: '来', romaji: 'rai', meaning: 'come', emoji: '🔜', word: { kana: '来る', romaji: 'kuru', meaning: 'to come' } },
  { char: '見', romaji: 'ken', meaning: 'see', emoji: '👀', word: { kana: '見る', romaji: 'miru', meaning: 'to see / look' }, components: ['目', '儿'] },
  { char: '食', romaji: 'shoku', meaning: 'eat', emoji: '🍽️', word: { kana: '食べる', romaji: 'taberu', meaning: 'to eat' } },
  { char: '飲', romaji: 'in', meaning: 'drink', emoji: '🥤', word: { kana: '飲む', romaji: 'nomu', meaning: 'to drink' }, components: ['食', '欠'] },
  { char: '読', romaji: 'doku', meaning: 'read', emoji: '📖', word: { kana: '読む', romaji: 'yomu', meaning: 'to read' }, components: ['言'], partial: true },
  { char: '書', romaji: 'sho', meaning: 'write', emoji: '✍️', word: { kana: '書く', romaji: 'kaku', meaning: 'to write' }, components: ['日'], partial: true },
  { char: '話', romaji: 'wa', meaning: 'talk', emoji: '💬', word: { kana: '話す', romaji: 'hanasu', meaning: 'to speak' }, components: ['言', '舌'] },
  { char: '聞', romaji: 'bun', meaning: 'hear', emoji: '👂', word: { kana: '聞く', romaji: 'kiku', meaning: 'to hear / ask' }, components: ['門', '耳'] },
  { char: '買', romaji: 'bai', meaning: 'buy', emoji: '🛒', word: { kana: '買う', romaji: 'kau', meaning: 'to buy' }, components: ['罒', '貝'] },
  { char: '休', romaji: 'kyuu', meaning: 'rest', emoji: '🛌', word: { kana: '休む', romaji: 'yasumu', meaning: 'to rest / be absent' }, components: ['人', '木'] },
  ...
  { char: '出', romaji: 'shutsu', meaning: 'exit', emoji: '🚪', word: { kana: '出る', romaji: 'deru', meaning: 'to exit / leave' }, components: ['山', '山'] },

  // School & misc essentials
  { char: '学', romaji: 'gaku', meaning: 'study', emoji: '🎓', word: { kana: '学校', romaji: 'gakkou', meaning: 'school' }, components: ['子'], partial: true },
  { char: '校', romaji: 'kou', meaning: 'school', emoji: '🏫', word: { kana: '高校', romaji: 'koukou', meaning: 'high school' }, components: ['木'], partial: true },
  { char: '語', romaji: 'go', meaning: 'language', emoji: '💬', word: { kana: '日本語', romaji: 'nihongo', meaning: 'Japanese language' }, components: ['言', '口'], partial: true },
  { char: '国', romaji: 'koku', meaning: 'country', emoji: '🌏', word: { kana: '韓国', romaji: 'kankoku', meaning: 'Korea' }, components: ['囗', '王'] },
  { char: '会', romaji: 'kai', meaning: 'meet', emoji: '🤝', word: { kana: '会社', romaji: 'kaisha', meaning: 'company' }, components: ['人'], partial: true },
  { char: '社', romaji: 'sha', meaning: 'company / shrine', emoji: '⛩️', word: { kana: '神社', romaji: 'jinja', meaning: 'Shinto shrine' }, components: ['示', '土'] },
  { char: '本', romaji: 'hon', meaning: 'book / origin', emoji: '📕', word: { kana: '日本', romaji: 'nihon', meaning: 'Japan' }, components: ['木', '一'] },
  { char: '何', romaji: 'nan', meaning: 'what', emoji: '❓', word: { kana: '何人', romaji: 'nannin', meaning: 'how many people' }, components: ['人', '口'], partial: true },
  { char: '間', romaji: 'kan', meaning: 'interval / between', emoji: '↔️', word: { kana: '人間', romaji: 'ningen', meaning: 'human being' }, components: ['門', '日'] },
]
