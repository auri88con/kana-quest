...
export const katakanaVoicedMnemonics = {
  ...
  'ギ': { story: 'The stripped-down key (キ) with ticks. KI to GI.', why: 'キ + dakuten.' },
  'グ': { story: 'The cornered beak (ク) with ticks. KU to GU.', why: 'ク + dakuten. Still two strokes plus the ticks — タ has three.' },
  'ゲ': { story: 'The lidded keg (ケ) with ticks. KE to GE.', why: 'ケ + dakuten.' },
  'ゴ': { story: 'The bracket (コ) with ticks. KO to GO.', why: 'コ + dakuten.' },
  'ザ': { story: 'The little fence (サ) starts buzzing. SA to ZA.', why: 'サ + dakuten.' },
  ...
  'ズ': { story: 'The kicking leg (ス) with ticks. SU to ZU.', why: 'ス + dakuten.' },
  'ゼ': { story: 'The straightened せ (セ) with ticks. SE to ZE.', why: 'セ + dakuten.' },
  ...
  'デ': { story: 'The two-bar table (テ) with ticks. TE to DE.', why: 'テ + dakuten.' },
  ...
  'ビ': { story: 'The flag on a pole (ヒ) with ticks. HI to BI.', why: 'ヒ + dakuten.' },
  'ブ': { story: 'The bent hook (フ) with ticks. FU to BU.', why: 'フ + dakuten.' },
  'ベ': { story: 'The free little hill (ヘ) with ticks. HE to BE.', why: 'ヘ + dakuten — and it is still identical to the hiragana べ.' },
  'ボ': { story: 'The kicking cross (ホ) with ticks. HO to BO.', why: 'ホ + dakuten.' },
}
...
export const katakanaHandakuonMnemonics = {
  ...
  'ピ': { story: 'The flag (ヒ) with a bubble on top. HI to PI.', why: 'ヒ + handakuten.' },
  'プ': { story: 'The hook (フ) blowing a bubble. FU to PU.', why: 'フ + handakuten.' },
  'ペ': { story: 'The little hill (ヘ) with a balloon. HE to PE.', why: 'ヘ + handakuten.' },
...
export const katakanaYoonMnemonics = {
  ...
  'キュ': { story: 'Key plus a small ユ. KYU — like the letter Q.', why: 'キ + small ュ. ki + yu → kyu.' },
  ...
  'チュ': { story: 'チ plus a small ユ. CHU.', why: 'チ + small ュ. chi + yu → chu.' },
  'チョ': { story: 'チ plus a small ヨ. CHO — チョコレート, chocolate.', why: 'チ + small ョ. chi + yo → cho.' },
  'ニャ': { story: 'Two lines plus a small ャ. NYA.', why: 'ニ + small ャ. ni + ya → nya.' },
  'ニュ': { story: 'ニ plus a small ユ. NYU — ニュース is the news.', why: 'ニ + small ュ. ni + yu → nyu.' },
  'ニョ': { story: 'ニ plus a small ヨ. NYO.', why: 'ニ + small ョ. ni + yo → nyo.' },
  'ヒャ': { story: 'The flag plus a small ャ. HYA.', why: 'ヒ + small ャ. hi + ya → hya.' },
  'ヒュ': { story: 'ヒ plus a small ユ. HYU — ヒューズ is a fuse.', why: 'ヒ + small ュ. hi + yu → hyu.' },
  'ヒョ': { story: 'ヒ plus a small ヨ. HYO.', why: 'ヒ + small ョ. hi + yo → hyo.' },
  'ミャ': { story: 'Three strokes plus a small ャ. MYA.', why: 'ミ + small ャ. mi + ya → mya.' },
  'ミュ': { story: 'ミ plus a small ユ. MYU — ミュージック is music.', why: 'ミ + small ュ. mi + yu → myu.' },
  'ミョ': { story: 'ミ plus a small ヨ. MYO.', why: 'ミ + small ョ. mi + yo → myo.' },
  'リャ': { story: 'The blade shape plus a small ャ. RYA.', why: 'リ + small ャ. ri + ya → rya.' },
  'リュ': { story: 'リ plus a small ユ. RYU — リュック is a rucksack.', why: 'リ + small ュ. ri + yu → ryu.' },
  'リョ': { story: 'リ plus a small ヨ. RYO.', why: 'リ + small ョ. ri + yo → ryo.' },
  'ギャ': { story: 'The ticked key plus a small ャ. GYA — ギャラリー is a gallery.', why: 'ギ + small ャ. Ticks first, then shrink the ya.' },
  'ギュ': { story: 'ギ plus a small ユ. GYU.', why: 'ギ + small ュ. gi + yu → gyu.' },
  'ギョ': { story: 'ギ plus a small ヨ. GYO.', why: 'ギ + small ョ. gi + yo → gyo.' },
  ...
  'ビャ': { story: 'The ticked flag plus a small ャ. BYA.', why: 'ビ + small ャ. bi + ya → bya.' },
  'ビュ': { story: 'ビ plus a small ユ. BYU — ビュッフェ is a buffet.', why: 'ビ + small ュ. bi + yu → byu.' },
  'ビョ': { story: 'ビ plus a small ヨ. BYO.', why: 'ビ + small ョ. bi + yo → byo.' },
  'ピャ': { story: 'The ballooned ヒ plus a small ャ. PYA.', why: 'ピ + small ャ. Circle for P, then shrink the ya.' },
  'ピュ': { story: 'ピ plus a small ユ. PYU — コンピューター has one.', why: 'ピ + small ュ. pi + yu → pyu.' },
  'ピョ': { story: 'ピ plus a small ヨ. PYO.', why: 'ピ + small ョ. pi + yo → pyo.' },
}
