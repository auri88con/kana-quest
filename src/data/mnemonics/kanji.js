...
export const kanjiReadingMnemonics = {
  ...
  '百': { hook: 'HYAKU — hear the H in front of “yak” and the rest follows. You will say it every time you hand over a 百円 coin.' },
  ...
  // Nature
  '山': { hook: 'YAMA — a llama with a Y on the front. And llamas do live up mountains.' },
  ...
  '車': { hook: 'KURUMA — three syllables, like an engine turning over: ku-ru-ma, ku-ru-ma. In compounds it flips to SHA — 電車 densha, a train.' },
  ...
  // Directions
  '上': { hook: 'UE — two vowels and no consonant at all: “oo” then “eh”. Say them separately and you have it. In compounds it becomes JOU — 上手 jouzu, skilful.' },
  ...
  '外': { hook: 'SOTO is the everyday reading — outdoors. In compounds it flips to GAI: 外国 gaikoku, a foreign country. One kanji, two lives.' },
  '東': { hook: 'HIGASHI on its own, four syllables: hi-ga-shi. In compounds it becomes TOU — 東京 Toukyou, the eastern capital.' },
  '西': { hook: 'NISHI — a niche in the west wall, with the sun setting into it. Like its partner 東 higashi, it changes in compounds.' },
  ...
  '立': { hook: 'RITSU is the compound reading — 国立 kokuritsu, national. On its own the verb is 立つ tatsu, to stand.' },
  '入': { hook: 'NYUU — new people, entering.' },
  '出': { hook: 'SHUTSU — it shoots you out the door.' },

  // School & places
  '学': { hook: 'GAKU — you already know it from 大学 daigaku, a university, and 学生 gakusei, a student.' },
  ...
  '国': { hook: 'KOKU is the compound reading — 中国 Chuugoku is China, 外国 gaikoku is abroad. On its own the kanji is kuni.' },
